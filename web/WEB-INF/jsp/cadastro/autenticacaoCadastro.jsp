...
<html>
    ...
    <body>
        <h1>Confirmação de Dados para Cadastro</h1>
        <form id="formulario" action="<c:url value='/cadastro/autenticarCadastro'/>" method="post" >
            Login: <input id="loginUsuario" name="login" type="text" /><br></br>
            Senha: <input id="senhaUsuario" name="senha" type="password" /><br></br>
            <input type="hidden" name="operacao" value="${param.operacao}"/>
            <input id="autenticar" type="button" value="Autenticar"/>
        </form>
    </body>
</html>
